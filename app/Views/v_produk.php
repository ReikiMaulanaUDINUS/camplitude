                        ...
                        <form action="<?= base_url('produk/edit/' . $produk['id']) ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="ket" class="form-control" id="ket" value="<?= $produk['ket'] ?>" placeholder="Keterangan Barang" required>
                                </div>
                            </div>
        ...
        <div class="modal-content">
            ...
            <form action="<?= base_url('produk') ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="name">Keterangan</label>
                        <input type="text" name="ket" class="form-control" id="ket" placeholder="Keterangan Barang" required>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
